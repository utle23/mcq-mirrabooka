...
ITEMS_SEED = [
    ...
    ('Mung Bean Sesame Ball',           'Bánh Cam Đậu Xanh',       'Tú Anh',          3.00, 1.50, 'mon,tue,wed,thu,fri,sat,sun', 1, 0),
    ('Red Bean Sesame Ball',            'Bánh Cam Đậu Đỏ',         'Golden Bites',    3.00, 1.50, 'mon,tue,wed,thu,fri,sat,sun', 1, 0),
    ('Banh Bao (Steam Bun)',            'Bánh Bao',                'Tú Anh',          5.50, 3.50, 'mon,tue,wed,thu,fri,sat,sun', 1, 0),
    ...
    ('Fried Pork Dumpling',             'Há Cảo Chiên',            'Golden Bites',    3.00, 1.50, 'mon,tue,wed,thu,fri,sat,sun', 1, 0),
    ('Fried Banana',                    'Chuối Chiên',             'MCQ Supermarket', 3.00, 1.10, 'mon,tue,wed,thu,fri,sat,sun', 0, 0),
    ...
    ('Chicken Curry Puffs (min. 300)',  'Bánh Cà Ri Gà (tối thiểu 300)', 'Chị Linh', 3.00, 1.80, '',                          0, 1),
